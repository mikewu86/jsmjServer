...
-- config_game.nodeid = tonumber(os.getenv("NODEID") or 12)
-- config_game.gameid = tonumber(os.getenv("GAMEID") or 12)
-- config_game.nodename = os.getenv("NODENAME") or "errenmj"
-- config_game.gamename = os.getenv("GAMENAME") or "二人麻将"
-- --最大房间数量
-- config_game.maxrooms = tonumber(os.getenv("MAXROOMS") or 2000)
-- config_game.minPlayers = tonumber(os.getenv("MINPLAYERS") or 2)
-- config_game.maxPlayers = tonumber(os.getenv("MAXPLAYERS") or 2)
...
--     config_game.gateaddr = os.getenv("GATEADDR") or "192.168.99.100:18012"
...
config_other = {}
--组id,用于区分其他服务器组
config_other.nodename = os.getenv("NODENAME") or "errenmj"
