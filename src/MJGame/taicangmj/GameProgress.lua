...
local MJPlayer = require("TCMJPlayer")
...
function GameProgress:ctor(room, roomId,unitCoin)
    ...
    self.roomRuleMap = {
       ['tc_playrule_baozi'] = false,    -- 豹子
       ['tc_playrule_2m3c'] = false, -- 二摸三冲
       ['tc_extrarule2_dnwh'] = false, -- 东南为花
       ['tc_extrarule1_100'] = false, -- 100分封顶
       ['tc_extrarule1_200'] = false, -- 200分封顶
       ['tc_extrarule1_wx'] = false, -- 无限大
    }
    self:createGameRule()

    self.huaList = {}
    if self.roomRuleMap['tc_extrarule2_dnwh'] then
