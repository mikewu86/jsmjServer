...
local baiDaCard = {
        ...
        MJConst.Zi3,MJConst.Zi4,MJConst.Zi1,MJConst.Zi2
    }
...
function FanDa:getDa()
    local daIndex = #baiDaCard
    if self.gameProgress.roomRuleMap['ks_extrarule2_dnwh'] then
        daIndex = daIndex - 2
    end
    local index = math.random(1,daIndex)
    ...
    -- 三百搭
    if self.gameProgress.roomRuleMap['ks_extrarule1_3z'] then
