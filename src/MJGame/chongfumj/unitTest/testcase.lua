...
testcase[8].handcards[1] = {
    '一万', '一万','一万','四万','四万','四万','六万','六万','六万','东','东','东', '二万'
}
...
-- 百搭对对胡
testcase[15] = {}
testcase[15].handcards = {}
-- 
testcase[15].handcards[1] = {
    '一万', '一万','一万','六条','七条','七条','七条','三条','三条','三条','二条','二条','二条'
}

-- 要自摸必须有新牌
testcase[15].newcards = {'九条'}
-- 花
testcase[15].huaList = {
    {'梅','大白板'},
    {'大白板'},
...
-- 百搭清一色
testcase[16] = {}
testcase[16].handcards = {}
-- 
testcase[16].handcards[1] = {
    '一万', '一万','一万','六条','七条','七条','七条','三条','三条','三条','五条','六条','七条'
}

-- 要自摸必须有新牌
testcase[16].newcards = {'九条'}
-- 花
testcase[16].huaList = {
    {'梅','大白板'},
    {'大白板'},
...
-- 百搭混一色
testcase[17] = {}
testcase[17].handcards = {}
-- 
testcase[17].handcards[1] = {
    '一万', '一万','一万','六条','七条','八条','九条','三条','三条','三条','西','西','西'
}

-- 要自摸必须有新牌
testcase[17].newcards = {'九条'}
-- 花
testcase[17].huaList = {
    {'梅','大白板'},
    {'大白板'},
