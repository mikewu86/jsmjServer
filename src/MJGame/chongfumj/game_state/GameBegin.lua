...
function GameBegin:onEntry(args)
    ...
    self.gameProgress.diceNum[1] = dices[1]
    self.gameProgress.diceNum[2] = dices[2] 
    -- 同步玩家数据
...
function GameBegin:onUserCutBack(_pos, uid)
    ...
    self.gameProgress:broadcastPlayerClientNotify(
        operSeq,
        kDiceShow, {self.gameProgress.diceNum[1], self.gameProgress.diceNum[2]})
end
