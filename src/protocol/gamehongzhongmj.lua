-- 游戏自定义消息（5xx-6xx)
local gamehongzhongmj = {}

gamehongzhongmj.types = [[
#data types
.detailsElem {
    pos  0 : integer
    describe  1 : string
...
warningNotify 623 {
    request {
        Type 0 : *integer #type in WHMJConst.lua
		MyPos 1 : integer
    }
}
...
vipTotalScoreAH 649 {
    request {
        userScore 0 : string #底分
        userJiao 1 : *integer #交
    }
}
# 安徽马鞍山麻将定缺
recommendSuit 650 {
