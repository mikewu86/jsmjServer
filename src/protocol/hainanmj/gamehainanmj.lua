...
gameResult 611 {
    request {
        ...
        huPoses 16 : *integer
        fangpaoPos 17 : integer
        baoPos 18 : integer
        baoType 19 : integer
        hua_cards1 20 : *integer 
        hua_cards2 21 : *integer
        hua_cards3 22 : *integer 
        hua_cards4 23 : *integer
    }
}
...
gameResultNotify 646 {
    request {
        ...
        details 6 : *detailsElem # 记录每个玩家hu类型的倍数
        money 7 : *integer
        hua_cards1 8 : *integer 
        hua_cards2 9 : *integer
        hua_cards3 10 : *integer 
        hua_cards4 11 : *integer
    }
}
